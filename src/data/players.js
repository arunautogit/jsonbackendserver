...
export const teamColors = {
    [teams.CSK]: 'linear-gradient(135deg, #f9cd05 0%, #ffba08 100%)',
    [teams.DC]: 'linear-gradient(135deg, #004c93 0%, #0358a7 100%)',
    [teams.GT]: 'linear-gradient(135deg, #1b2133 0%, #283549 100%)',
    [teams.KKR]: 'linear-gradient(135deg, #3a225d 0%, #b3a5d8 100%)',
    [teams.LSG]: 'linear-gradient(135deg, #a0d4ff 0%, #005697 100%)',
    [teams.MI]: 'linear-gradient(135deg, #004b8d 0%, #005ea0 100%)',
    [teams.PBKS]: 'linear-gradient(135deg, #dd1f2d 0%, #ed1c24 100%)',
    [teams.RCB]: 'linear-gradient(135deg, #2b2b2b 0%, #db0030 100%)',
    [teams.RR]: 'linear-gradient(135deg, #ea1a85 0%, #eb4d9c 100%)',
    [teams.SRH]: 'linear-gradient(135deg, #f7a721 0%, #fb643e 100%)',
};

export const teamLogos = {
    [teams.CSK]: 'https://upload.wikimedia.org/wikipedia/en/2/2b/Chennai_Super_Kings_Logo.svg',
    [teams.DC]: 'https://upload.wikimedia.org/wikipedia/en/2/2f/Delhi_Capitals_Logo.svg',
    [teams.GT]: 'https://upload.wikimedia.org/wikipedia/en/c/cc/Gujarat_Titans_Logo.svg',
    [teams.KKR]: 'https://upload.wikimedia.org/wikipedia/en/4/4c/Kolkata_Knight_Riders_Logo.svg',
    [teams.LSG]: 'https://upload.wikimedia.org/wikipedia/en/a/a9/Lucknow_Super_Giants_IPL_Logo.svg',
    [teams.MI]: 'https://upload.wikimedia.org/wikipedia/en/c/cd/Mumbai_Indians_Logo.svg',
    [teams.PBKS]: 'https://upload.wikimedia.org/wikipedia/en/2/25/Punjab_Kings_Logo.svg',
    [teams.RCB]: 'https://upload.wikimedia.org/wikipedia/en/2/2a/Royal_Challengers_Bangalore_2020.svg',
    [teams.RR]: 'https://upload.wikimedia.org/wikipedia/en/6/60/Rajasthan_Royals_Logo.svg',
    [teams.SRH]: 'https://upload.wikimedia.org/wikipedia/en/8/81/Sunrisers_Hyderabad.svg',
};
